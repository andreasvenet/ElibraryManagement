                    ...
                    <div class="card-body">
                           ...
                           <div class="col-md-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:LinkButton class="btn btn-success mr-1" ID="Button4" runat="server" Text="S" OnClick="Button4_Click"><i class="fas fa-check-circle"></i></asp:LinkButton>
                                    ...
                                    <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton2" runat="server" Text="D" OnClick="LinkButton2_Click"><i class="fas fa-times-circle"></i></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox1" runat="server" placeholder="Contact No" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox2" runat="server" placeholder="Email ID" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
